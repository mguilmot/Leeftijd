### Enkel op run klikken, full auto :-)
### Hieronder niks veranderen

import time, calendar

class CalcTime(object):
    def __init__(self,birthdate,personname):
    ...
    def printresult(self):
        ...
        return "Leeftijd " + self.personname + ": " + str(result[0]) + " jaar, " + str(result[1]) + " maanden, " + str(result[2]) + " dagen."

Gegevens = [("21112016","Amélie"),("10051987","Katrien"),("25061981","Mike")]

for person in Gegevens:
    leeftijd = CalcTime(birthdate=person[0], personname=person[1])
    print(leeftijd.printresult())
